...
namespace RuinMod.Content.Tools.Hooks.Hardmode.StarHook
{
    internal class StarHook : ModItem
    {
        public override void SetStaticDefaults()
        {
            //DisplayName.SetDefault("Star Hook"); // The item's name in-game.
        ...
        public override void SetDefaults()
        {
            ...
            Item.shoot = ModContent.ProjectileType<StarHookProjectile>(); // Makes the item shoot the hook's projectile when used.
            Item.rare = ItemRarityID.Pink;
            Item.value = 0;
        }
    }

    internal class StarHookProjectile : ModProjectile
    {
        ...
        { // This is called once on mod (re)load when this piece of content is being loaded.
          // This is the path to the texture that we'll use for the hook's chain. Make sure to update it.
            chainTexture = ModContent.Request<Texture2D>("RuinMod/Content/Tools/Hooks/Hardmode/StarHook/StarHookChain");
        }
        ...
        {
            speed = 15; // How fast you get pulled to the grappling hook projectile's landing position
        }
