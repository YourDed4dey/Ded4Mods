...
namespace RuinMod.Content.Tools.Hooks.Hardmode.MechanicalHook
{
    internal class MechanicalHook : ModItem
    {
        public override void SetStaticDefaults()
        {
            //DisplayName.SetDefault("Mechanical Hook"); // The item's name in-game.
        ...
        public override void SetDefaults()
        {
            ...
            Item.shoot = ModContent.ProjectileType<MechanicalHookProjectile>(); // Makes the item shoot the hook's projectile when used.
    ...
    internal class MechanicalHookProjectile : ModProjectile
    {
        ...
        { // This is called once on mod (re)load when this piece of content is being loaded.
          // This is the path to the texture that we'll use for the hook's chain. Make sure to update it.
            chainTexture = ModContent.Request<Texture2D>("RuinMod/Content/Tools/Hooks/Hardmode/MechanicalHook/MechanicalHookChain");
        }
        ...
        {
            numHooks = 8; // The amount of hooks that can be shot out
        }

        // default is 11, Lunar is 24
        public override void GrappleRetreatSpeed(Player player, ref float speed)
        {
            speed = 30f; // How fast the grapple returns to you after meeting its max shoot distance
        }
