...
namespace RuinMod.Content.Armor.PreHardmode.Ranger.SapphireArmor
{
    ...
    internal class SapphireHelmet : ModItem
    {
        public override void SetStaticDefaults()
        {
            //DisplayName.SetDefault("Sapphire Helmet");
        ...
        {
            return body.type == ItemType<SapphireChestplate>() && legs.type == ItemType<SapphireLeggings>(); //What makes armor set bonus work
        }
        ...
        public override void UpdateArmorSet(Player player) //Armor set bonuses
        {
            ...
            player.setBonus = Language.GetTextValue("Mods.RuinMod.ItemSetBonus.SapphireSet");
