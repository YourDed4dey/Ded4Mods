...
using RuinMod.Content.Weapons.ShieldClassWeapons.PreHardmode.TungstenShield;
using RuinMod.Content.Weapons.ShieldClassWeapons.PreHardmode.SilverShield;
...
namespace RuinMod.Content.Weapons.ShieldClassWeapons.PreHardmode.WoodShield
{
    ...
    internal class WoodShield : ModItem
    {
        ...
        {
            //DisplayName.SetDefault("Wood Shield");
            //Tooltip.SetDefault("");
        }
