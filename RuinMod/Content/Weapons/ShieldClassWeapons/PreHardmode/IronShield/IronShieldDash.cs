...
namespace RuinMod.Content.Weapons.ShieldClassWeapons.PreHardmode.IronShield
{
    public class IronShieldDash : ModPlayer
    {
        ...
        public const float DashVelocity = 8f; //5-9 is slow, 10-16 is medium,17-22 is fast, 23-30 is insanely fast, above that is TOO fast
