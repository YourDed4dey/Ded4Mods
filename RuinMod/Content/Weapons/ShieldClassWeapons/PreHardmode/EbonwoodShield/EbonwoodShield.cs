...
using RuinMod.Content.Weapons.ShieldClassWeapons.PreHardmode.DemoniteShield;
using System.Collections.Generic;

namespace RuinMod.Content.Weapons.ShieldClassWeapons.PreHardmode.EbonwoodShield
{
    [AutoloadEquip(EquipType.Shield)]
    internal class EbonwoodShield : ModItem
    {
