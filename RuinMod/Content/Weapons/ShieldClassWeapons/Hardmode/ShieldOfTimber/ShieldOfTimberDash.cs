...
{
    public class ShieldOfTimberDash : ModPlayer
    {
            ...
            if (DashTimer > 0)
            {
                ...
                for (int i = 0; i < 200; i++)
                {
                    ...
                    if (rectangle.Intersects(rect) && (nPC.noTileCollide || Player.CanHit(nPC)))
                    {
                        ...
                        if (Player.whoAmI == Main.myPlayer)
                        {
                                Vector2 position = Main.MouseWorld + new Vector2(Main.rand.Next(1, 21) + Main.rand.Next(1, 141));
                                ...
                                float num1 = 10f * shieldDamage1;

                                Projectile.NewProjectile(null, position, direction * speed, ModContent.ProjectileType<AppleProjectile>(), (int)(num1), 0, Main.myPlayer);
                                Projectile.NewProjectile(null, position1, direction * speed, ModContent.ProjectileType<BananaProjectile>(), (int)(num1), 0, Main.myPlayer);
                                Projectile.NewProjectile(null, position2, direction * speed, ModContent.ProjectileType<BlackcurrantProjectile>(), (int)(num1), 0, Main.myPlayer);
                                Projectile.NewProjectile(null, position3, direction * speed, ModContent.ProjectileType<BloodOrangeProjectile>(), (int)(num1), 0, Main.myPlayer);
                                Projectile.NewProjectile(null, position4, direction * speed, ModContent.ProjectileType<CherryProjectile>(), (int)(num1), 0, Main.myPlayer);
                                Projectile.NewProjectile(null, position5, direction * speed, ModContent.ProjectileType<DragonFruitProjectile>(), (int)(num1), 0, Main.myPlayer);
                                Projectile.NewProjectile(null, position6, direction * speed, ModContent.ProjectileType<PineappleProjectile>(), (int)(num1), 0, Main.myPlayer);
                        }
