...
{
    public class ShroomiteShieldDash : ModPlayer
    {
        ...
        public static float DashVelocity = 22f; //5-9 is slow, 10-16 is medium,17-22 is fast, 23-30 is insanely fast, above that is TOO fast
