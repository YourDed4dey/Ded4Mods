...
{
	internal class TestBossHand : ModNPC
	{
		...
		{
			return ModContent.NPCType<TestBoss>();
		}
		...
		{
			//DisplayName.SetDefault("Test Boss Hand");
		...
		private void MoveInFormation()
		{
			...
			float rad = (float)PositionIndex / TestBoss.MinionCount() * MathHelper.TwoPi;
