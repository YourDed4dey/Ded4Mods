...
namespace RuinMod.Content.Items.Drops.EssencesOrSoulsOrFragments.Souls.SoulOfInertness
{
    internal class SoulOfInertness : ModItem
    {
        public override void SetStaticDefaults()
        {
            //DisplayName.SetDefault("Soul Of Inertness");
