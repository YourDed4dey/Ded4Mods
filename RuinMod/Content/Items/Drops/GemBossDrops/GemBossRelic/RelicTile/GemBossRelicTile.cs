...
namespace RuinMod.Content.Items.Drops.GemBossDrops.GemBossRelic.RelicTile
{
    internal class GemBossRelicTile : ModTile
    {
        ...
        public virtual string RelicTextureName => "RuinMod/Content/Items/Drops/GemBossDrops/GemBossRelic/RelicTile/GemBossRelicTile";
        ...
        public override void KillMultiTile(int i, int j, int frameX, int frameY)
        {
            ...
            {
                case 0:
                    itemType = ModContent.ItemType<GemBossRelic>();
                    break;
