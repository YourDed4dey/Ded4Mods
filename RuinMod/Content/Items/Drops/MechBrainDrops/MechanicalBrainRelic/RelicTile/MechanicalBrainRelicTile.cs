...
namespace RuinMod.Content.Items.Drops.MechBrainDrops.MechanicalBrainRelic.RelicTile
{
    ...
    public class MechanicalBrainRelicTile : ModTile
    {
        ...
        public virtual string RelicTextureName => "RuinMod/Content/Items/Drops/MechBrainDrops/MechanicalBrainRelic/RelicTile/MechanicalBrainRelicTile";

        // All relics use the same pedestal texture, this one is copied from vanilla
        public override string Texture => "RuinMod/Content/Items/RelicPedestal/RelicPedestal";
        ...
        public override void KillMultiTile(int i, int j, int frameX, int frameY)
        {
            ...
            {
                case 0:
                    itemType = ModContent.ItemType<MechanicalBrainRelic>();
                    break;
