...
namespace RuinMod.Content.Projectiles.GamerClass.Batarang
{
    internal class BatarangProjectile : ModProjectile
    {
        ...
        {
            int dust = Dust.NewDust(Projectile.Center, 1, 1, DustID.BatScepter, 0f, 0f, 0, default(Color), 1f);
