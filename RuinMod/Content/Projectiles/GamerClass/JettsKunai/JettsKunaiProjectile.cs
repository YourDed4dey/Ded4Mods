...
namespace RuinMod.Content.Projectiles.GamerClass.JettsKunai
{
    internal class JettsKunaiProjectile : ModProjectile
    {
        ...
        {
            int dust = Dust.NewDust(Projectile.Center, 1, 1, DustID.Cloud, 0f, 0f, 0, default(Color), 1f);
