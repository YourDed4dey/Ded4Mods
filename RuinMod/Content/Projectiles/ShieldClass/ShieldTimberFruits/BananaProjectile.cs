...
{
    internal class BananaProjectile : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            {
                Dust dust18 = Dust.NewDustDirect(new Vector2(Projectile.position.X - 2f, Projectile.position.Y - 2f), Projectile.width + 4, Projectile.height + 4, DustID.PalmWood, Projectile.velocity.X * 0.4f, Projectile.velocity.Y * 0.4f, 100, default(Color), .5f);
        ...
        {
            int backGoreType = Mod.Find<ModGore>("BananaProjectile_Back").Type;
            int frontGoreType = Mod.Find<ModGore>("BananaProjectile_Front").Type;
