...
{
    internal class SwordOfSoulsBlightProjectile : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (target)
            {
                ...
                Projectile.velocity = (10 * Projectile.velocity + move) / 5f; //11f
                AdjustMagnitude(ref Projectile.velocity);
            }
            ...
            {
                int num30 = Dust.NewDust(vector14 - Projectile.Size / 2f, Projectile.width, Projectile.height, DustID.YellowTorch, Projectile.velocity.X, Projectile.velocity.Y, 100, default(Color), 2f);
