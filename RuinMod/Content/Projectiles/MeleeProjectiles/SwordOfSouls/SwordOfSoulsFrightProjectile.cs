...
{
    internal class SwordOfSoulsFrightProjectile : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            {    
                int num30 = Dust.NewDust(vector14 - Projectile.Size / 2f, Projectile.width, Projectile.height, DustID.OrangeTorch, Projectile.velocity.X, Projectile.velocity.Y, 100, default(Color), 2f);
