...
namespace RuinMod.Content.Projectiles.ChainClass.WoodenChain.EbonWoodenStringProjectile;

internal class EbonWoodenStringProjectile : ModProjectile
{
	public override void SetStaticDefaults()
	{
		//DisplayName.SetDefault("Ebonwood Wooden String");
	}
