...
namespace RuinMod.Content.Projectiles.ChainClass.WoodenChain.ShadeWoodenStringProjectile;

internal class ShadeWoodenStringProjectile : ModProjectile
{
	public override void SetStaticDefaults()
	{
		//DisplayName.SetDefault("Shadewood Wooden String");
	}
