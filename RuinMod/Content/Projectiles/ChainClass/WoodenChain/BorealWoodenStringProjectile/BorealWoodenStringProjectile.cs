...
namespace RuinMod.Content.Projectiles.ChainClass.WoodenChain.BorealWoodenStringProjectile;

internal class BorealWoodenStringProjectile : ModProjectile
{
	public override void SetStaticDefaults()
	{
		//DisplayName.SetDefault("Borealwood Wooden String");
	}
