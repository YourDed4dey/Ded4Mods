...
namespace RuinMod.Content.Projectiles.ChainClass.ChainsOfAmgil
{
    internal class ChainsOfAmgilProjectile : ModProjectile
    {
		public override void SetStaticDefaults()
		{
			//DisplayName.SetDefault("Chain of Amgil");
		}
