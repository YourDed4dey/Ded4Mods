    ...
    public class Helper_Magic : ModItem
    {
        ...
        private int GetBossHelp(ref string build, Player player)
        {
            ...
            if (!NPC.downedSlimeKing)
            {
                ...
                build = GetBuildText(
                    Main.rand.Next(new int[] { ItemID.AncientCobaltHelmet }),
                    ...
                    Main.rand.Next(new int[] { ItemID.RubyStaff, ItemID.DiamondStaff, ItemID.ThunderStaff, ItemID.CrimsonRod, ItemID.Vilethorn,ItemID.DemonScythe })
                );
            }
