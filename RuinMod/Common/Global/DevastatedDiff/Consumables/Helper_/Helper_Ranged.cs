...
using RuinMod.Content.Items.Ammo.Unlimited.Bullets;
using RuinMod.Content.Items.Ammo.Unlimited.Arrows;

namespace RuinMod.Common.Global.DevastatedDiff.Consumables.Helper_
{
    public class Helper_Ranged : ModItem
    {
        //public override string Texture => "Terraria/Images/Item_" + ItemID.Handgun;
        public override void SetStaticDefaults()
        {
            ////DisplayName.SetDefault("Helper!");
            ////Tooltip.SetDefault("Informs on good gear for ranged users\n'Is it too hard ;('");
        }
        ...
        private int GetBossHelp(ref string build, Player player)
        {
            ...
            if (!NPC.downedSlimeKing)
            {
                ...
                build = GetBuildText(
                    Main.rand.Next(new int[] { ItemID.FossilHelm }),
                    ...
                    Main.rand.Next(new int[] { ItemID.Minishark, ItemID.Musket, ItemID.Boomstick, ItemID.DemonBow, ItemID.TendonBow, ItemID.BloodRainBow, ItemID.TheUndertaker }),
                    Main.rand.Next(new int[] { ModContent.ItemType<UnlimitedSilverBullet>(), ModContent.ItemType<UnlimitedTungstenBullet>(), ModContent.ItemType<UnlimitedFlamingArrow>() })
                );
            }
