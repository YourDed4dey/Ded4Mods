...
{
    public class Helper_Melee : ModItem
    {
        //public override string Texture => "Terraria/Images/Item_" + ItemID.AdamantiteSword;
        public override void SetStaticDefaults()
        {
            //DisplayName.SetDefault("Helper!");
            //Tooltip.SetDefault("Informs on good gear for fighters\n'Is it too hard ;('");
        }
        ...
        private int GetBossHelp(ref string build, Player player)
        {
            ...
            if (!NPC.downedSlimeKing)
            {
                ...
                build = GetBuildText(
                    Main.rand.Next(new int[] { ItemID.AncientShadowHelmet }),
                    ...
                    Main.rand.Next(new int[] { ItemID.Starfury, ItemID.EnchantedSword, ItemID.ThunderSpear })
                );
            }
        ...
        public override bool? UseItem(Player player)
        {
            if (player.ItemTimeIsZero)
            {
                ...
                SoundEngine.PlaySound(SoundID.Bird, player.Center);
            }
            return true;
        }
