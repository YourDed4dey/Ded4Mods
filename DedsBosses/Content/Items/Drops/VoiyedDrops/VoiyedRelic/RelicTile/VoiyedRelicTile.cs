...
namespace DedsBosses.Content.Items.Drops.VoiyedDrops.VoiyedRelic.RelicTile
{
    ...
    public class VoiyedRelicTile : ModTile
    {
        ...
        public virtual string RelicTextureName => "DedsBosses/Content/Items/Drops/VoiyedDrops/VoiyedRelic/RelicTile/VoiyedRelicTile";

        // All relics use the same pedestal texture, this one is copied from vanilla
        public override string Texture => "DedsBosses/Content/Items/RelicPedestal/RelicPedestal";
