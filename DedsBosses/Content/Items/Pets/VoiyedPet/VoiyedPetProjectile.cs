...
namespace DedsBosses.Content.Items.Pets.VoiyedPet
{
    internal class VoiyedPetProjectile : ModProjectile
    {
        ...
        {
            Projectile.CloneDefaults(ProjectileID.EyeOfCthulhuPet); // Copy the stats of the Zephyr Fish

            AIType = ProjectileID.EyeOfCthulhuPet; // Mimic as the Zephyr Fish during AI.
        }
        ...
        public override void AI()
        {
            ...
            if (!player.dead && player.HasBuff(ModContent.BuffType<VoiyedPetBuff>()))
            {
