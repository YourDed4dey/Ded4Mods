...
{
    public class ThrowablePalladiumScythe : ModProjectile
    {
        public bool healthRegenActive = false;
        ...
        {
            if (!healthRegenActive && target.type != NPCID.TargetDummy && !target.friendly)
            {
