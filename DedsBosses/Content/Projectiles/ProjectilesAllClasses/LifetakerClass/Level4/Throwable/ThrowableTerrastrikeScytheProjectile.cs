...
namespace DedsBosses.Content.Projectiles.ProjectilesAllClasses.LifetakerClass.Level4.Throwable
{
    public class ThrowableTerrastrikeScytheProjectile : ModProjectile
    {
