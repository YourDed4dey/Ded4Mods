...
{
    public class SlimedEnchantedScythe : ModItem
    {
        int spinScythe = ModContent.ProjectileType<SpinningSlimedEnchantedScythe>();
        int throwScythe = ModContent.ProjectileType<ThrowableSlimedEnchantedScythe>();
