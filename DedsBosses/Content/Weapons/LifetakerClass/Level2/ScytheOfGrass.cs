...
{
    public class ScytheOfGrass : ModItem
    {
        int spinScythe = ModContent.ProjectileType<SpinningScytheOfGrass>();
        int throwScythe = ModContent.ProjectileType<ThrowableScytheOfGrass>();
