...
{
    public class EnchantedScythe : ModItem
    {
        int spinScythe = ModContent.ProjectileType<SpinningEnchantedScythe>();
        int throwScythe = ModContent.ProjectileType<ThrowableEnchantedScythe>();
