...
namespace DedsBosses.Content.Weapons.LifetakerClass.Level2
{
    ...
    {
        int spinScythe = ModContent.ProjectileType<SpinningCobaltScythe>();
        int throwScythe = ModContent.ProjectileType<ThrowableCobaltScythe>();
        ...
        public override bool Shoot(Player player, EntitySource_ItemUse_WithAmmo source, Vector2 position, Vector2 velocity, int type, int damage, float knockback)
        {
            ...
            {
                int proj = Projectile.NewProjectile(source, position, velocity, spinScythe, damage, knockback, player.whoAmI);
