...
{
    public class Moonshadow : ModItem
    {
        int spinScythe = ModContent.ProjectileType<SpinningMoonshadow>();
        int throwScythe = ModContent.ProjectileType<ThrowableMoonshadow>();
