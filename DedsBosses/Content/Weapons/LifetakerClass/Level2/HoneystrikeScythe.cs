...
{
    public class HoneystrikeScythe : ModItem
    {
        int spinScythe = ModContent.ProjectileType<SpinningHoneystrikeScythe>();
        int throwScythe = ModContent.ProjectileType<ThrowableHoneystrikeScythe>();
