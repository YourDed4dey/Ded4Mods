...
{
    public class BloodfireScythe : ModItem
    {
        int spinScythe = ModContent.ProjectileType<SpinningBloodfireScythe>();
        int throwScythe = ModContent.ProjectileType<ThrowableBloodfireScythe>();
