...
{
    public class TwilightCleaver : ModItem
    {
        int spinScythe = ModContent.ProjectileType<SpinningTwilightCleaver>();
        int throwScythe = ModContent.ProjectileType<ThrowableTwilightCleaver>();
