...
{
    public class ShroomiteScythe : ModItem
    {
        int spinScythe = ModContent.ProjectileType<SpinningShroomiteScythe>();
        int throwScythe = ModContent.ProjectileType<ThrowableShroomiteScythe>();
