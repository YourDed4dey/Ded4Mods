...
{
    public class SpookwoodSlicer : ModItem
    {
        int spinScythe = ModContent.ProjectileType<SpinningSpookwoodSlicer>();
        int throwScythe = ModContent.ProjectileType<ThrowableSpookwoodSlicer>();
