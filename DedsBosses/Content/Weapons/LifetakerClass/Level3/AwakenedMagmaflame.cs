...
{
    public class AwakenedMagmaflame : ModItem
    {
        int spinScythe = ModContent.ProjectileType<SpinningAwakenedMagmaflame>();
        int throwScythe = ModContent.ProjectileType<ThrowableAwakenedMagmaflame>();
