...
{
    public class ThornyReaver : ModItem
    {
        int spinScythe = ModContent.ProjectileType<SpinningThornyReaver>();
        int throwScythe = ModContent.ProjectileType<ThrowableThornyReaver>();
