...
{
    public class TrueTwilightCleaver : ModItem
    {
        int spinScythe = ModContent.ProjectileType<SpinningTrueTwilightCleaver>();
        int throwScythe = ModContent.ProjectileType<ThrowableTrueTwilightCleaver>();
