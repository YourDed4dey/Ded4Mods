...
{
    public class UnawakenedMagmaflame : ModItem
    {
        int spinScythe = ModContent.ProjectileType<SpinningUnawakenedMagmaflame>();
        int throwScythe = ModContent.ProjectileType<ThrowableUnawakenedMagmaflame>();
