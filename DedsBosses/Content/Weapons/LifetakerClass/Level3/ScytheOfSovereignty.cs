...
{
    public class ScytheOfSovereignty : ModItem
    {
        int spinScythe = ModContent.ProjectileType<SpinningScytheOfSovereignty>();
        int throwScythe = ModContent.ProjectileType<ThrowableScytheOfSovereignty>();
