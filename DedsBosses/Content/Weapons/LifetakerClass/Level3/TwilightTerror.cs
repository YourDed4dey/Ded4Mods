...
{
    public class TwilightTerror : ModItem
    {
        int spinScythe = ModContent.ProjectileType<SpinningTwilightTerror>();
        int throwScythe = ModContent.ProjectileType<ThrowableTwilightTerror>();
