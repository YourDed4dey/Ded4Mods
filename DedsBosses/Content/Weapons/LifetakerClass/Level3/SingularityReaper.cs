...
{
    public class SingularityReaper : ModItem
    {
        int spinScythe = ModContent.ProjectileType<SpinningSingularityReaper>();
        int throwScythe = ModContent.ProjectileType<ThrowableSingularityReaper>();
