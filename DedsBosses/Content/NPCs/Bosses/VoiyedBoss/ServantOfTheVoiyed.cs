...
namespace DedsBosses.Content.NPCs.Bosses.VoiyedBoss
{
    public class ServantOfTheVoiyed : ModNPC
    {
        ...
        /*Normal Mode:
            - Summon does 30 damage  - Summon has 300 hp

            Expert Mode:
            - Summon does 69 damage - Summon has 420 hp //? on 2 players (1.35 is multiplier for each player)
            
            Master Mode:
            - Summon does 103 damage - Summon has 630 hp //? on 2 players (1.35 is multiplier for each player)
            ...
            - Summon does 103 damage - Summon has 630 hp //? on 2 players (1.35 is multiplier for each player)
             ...
             FTW Legendary Mode:
            - Summon does 184 damage - Summon has 840 hp //? on 2 players (1.35 is multiplier for each player)*/
