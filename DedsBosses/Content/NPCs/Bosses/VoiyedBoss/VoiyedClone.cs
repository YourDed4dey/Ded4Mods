...
namespace DedsBosses.Content.NPCs.Bosses.VoiyedBoss
{
    ...
    public class VoiyedClone : ModNPC
    {
        ...
        /*Normal Mode:
            - Clone does 50 damage in Stage 1  - Clone has 9500 hp

            Expert Mode:
            - Clone does 115 damage in Stage 1 - Clone has 13300 hp //? on 2 players (1.35 is multiplier for each player)
            
            Master Mode:
            - Clone does 172 damage in Stage 1 - Clone has 19950 hp //? on 2 players (1.35 is multiplier for each player)
            ...
            - Clone does 172 damage in Stage 1 - Clone has 19950 hp //? on 2 players (1.35 is multiplier for each player)
             ...
             FTW Legendary Mode:
            - Clone does 305 damage in Stage 1 - Clone has 26600 hp //? on 2 players (1.35 is multiplier for each player)*/
        ...
        public override void AI()
        {
            ...
            if (SecondStage)
            {
                ...
                if (aiTimer >= 60)
                {
                    float randomVelocity = Main.rand.NextFloat(10f, 14f);
