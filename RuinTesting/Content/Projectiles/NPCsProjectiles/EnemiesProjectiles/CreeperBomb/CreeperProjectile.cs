...
namespace RuinTesting.Content.Projectiles.NPCSProjectiles.EnemiesProjectiles.CreeperBomb
{
    internal class CreeperProjectile : ModProjectile
    {
                        ...
                        if (distanceToTile < (double)explosionRadius)
                        {
                            ...
                            if (Main.tile[i, j] != null) //&& Main.tile[i, j].active())
                            {
                                ...
                                if (canKillTile)
                                {
                                    ...
                                    if (/*!Main.tile[i, j]() && Main.netMode != NetmodeID.SinglePlayer)
                                    {
