...
namespace RuinTesting.Common.Systems.DevaSystem.Toggler
{
    public static class ToggleLoader
    {
        ...
        public static void Load()
        {
            ...
            LoadTogglesFromAssembly(RuinTesting.Instance.Code);
        }
        ...
        public static void LoadTogglesFromAssembly(Assembly assembly)
        {
            ...
            RuinTesting.Instance.Logger.Info($"ToggleCollections found: {orderedCollections.Count()}");
