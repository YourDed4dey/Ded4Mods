...
{
    public class Amethyst : ModProjectile
    {
        ...
        public override void Kill(int timeLeft)
        {
            ...
            {
                Dust.NewDust(Projectile.position, Projectile.width, Projectile.height, DustID.GemAmethyst, 0f, 0f, 150, default(Color), 1.2f);
            }
        }
    }
}
