...
namespace DedsQOLMod.Content.Items.Drops.GemmyDrops.GemmyRelic.RelicTile
{
    internal class GemmyRelicTile : ModTile
    {
        ...
        public virtual string RelicTextureName => "DedsQOLMod/Content/Items/Drops/GemmyDrops/GemmyRelic/RelicTile/GemmyRelicTile";

        // All relics use the same pedestal texture, this one is copied from vanilla
        public override string Texture => "DedsQOLMod/Content/Items/RelicPedestal/RelicPedestal";
