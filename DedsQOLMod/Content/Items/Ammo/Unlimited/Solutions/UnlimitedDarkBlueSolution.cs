...
{
    internal class UnlimitedDarkBlueSolution : ModItem
    {
        public override string Texture => "Terraria/Images/Item_" + ItemID.DarkBlueSolution;
        ...
        {
            CreateRecipe()
                .AddIngredient(ItemID.DarkBlueSolution, 3996)
                .Register();
        }
    }
}
