...
{
    internal class UnlimitedClusterRocketI : ModItem
    {
        public override string Texture => "Terraria/Images/Item_" + ItemID.ClusterRocketI;
        ...
        {
            CreateRecipe()
                .AddIngredient(ItemID.ClusterRocketI, 3996)
                .Register();
        }
    }
}
