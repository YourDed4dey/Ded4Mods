...
{
    internal class UnlimitedHoneyRocket : ModItem
    {
        public override string Texture => "Terraria/Images/Item_" + ItemID.HoneyRocket;
        public override void SetStaticDefaults()
        {
            Item.CloneDefaults(ItemID.HoneyRocket);
