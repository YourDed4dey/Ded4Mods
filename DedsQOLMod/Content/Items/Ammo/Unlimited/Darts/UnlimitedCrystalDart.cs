...
namespace DedsQOLMod.Content.Items.Ammo.Unlimited.Darts
{
    internal class UnlimitedCrystalDart : ModItem
    {
        public override string Texture => "Terraria/Images/Item_" + ItemID.CrystalDart;
