...
{
    internal class UnlimitedStars : ModItem
    {
        public override string Texture => "Terraria/Images/Item_" + ItemID.FallenStar;
        public override void SetStaticDefaults()
        {
            Item.CloneDefaults(ItemID.FallenStar);
            Main.RegisterItemAnimation(Item.type, new DrawAnimationVertical(10, 8)); // first it the amount of ticks per frame and second is the number of frames 
        ...
        {
            CreateRecipe()
                .AddIngredient(ItemID.FallenStar, 150)
                .Register();
        }
    }
}
