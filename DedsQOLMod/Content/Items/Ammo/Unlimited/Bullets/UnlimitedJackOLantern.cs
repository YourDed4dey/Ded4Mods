...
{
    internal class UnlimitedJackOLantern : ModItem
    {
        public override string Texture => "Terraria/Images/Item_" + ItemID.ExplosiveJackOLantern;
        ...
        {
            Item.CloneDefaults(ItemID.ExplosiveJackOLantern);
            Item.maxStack = 1;
        ...
        {
            CreateRecipe()
                .AddIngredient(ItemID.ExplosiveJackOLantern, 3996)
                .Register();
        }
    }
}
