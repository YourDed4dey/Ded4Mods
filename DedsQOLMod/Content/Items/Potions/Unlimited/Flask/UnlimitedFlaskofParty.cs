...
{
    internal class UnlimitedFlaskofParty : ModItem
    {
        public override string Texture => "Terraria/Images/Item_" + ItemID.FlaskofParty;
        public override void SetStaticDefaults()
        {
            Item.CloneDefaults(ItemID.FlaskofParty);
            //DisplayName.SetDefault("Unlimited Flask of Party");
            //Tooltip.SetDefault("Melee and Whip attacks cause confetti to appear\n[c/FFFF00:How much can you drink?]");
